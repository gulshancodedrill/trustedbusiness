    ...
    <body class="bg-background text-foreground">
        @php
            $biz = [
                ...
                'phone' => '(415) 555-0198',
                'website' => 'https://techfixpro.example.com',
                ...
                'services' => ['Phone Repair', 'Laptop Repair', 'Tablet Repair', 'Data Recovery', 'Screen Replacement'],
                'responseTime' => 'Under 30 min',
                'verified' => true,
                'topRated' => true,
                'ratingBreakdown' => [160, 20, 6, 2, 1],
            ];

            $reviews = [
                ['name' => 'James K.', 'rating' => 5, 'text' => 'Fixed my laptop in under an hour. Fair price and great communication throughout the process.', 'date' => 'December 20, 2024', 'avatar' => 'J', 'verified' => true],
                ['name' => 'Anna W.', 'rating' => 5, 'text' => 'Cracked my iPhone screen and they replaced it in 20 minutes. Looks brand new! Highly recommend.', 'date' => 'December 5, 2024', 'avatar' => 'A', 'verified' => true],
                ['name' => 'Chris D.', 'rating' => 4, 'text' => 'Good service overall. They were transparent about pricing and kept me updated. Minor delay but quality work.', 'date' => 'November 15, 2024', 'avatar' => 'C', 'verified' => false],
            ];
                        ...
                        <div class="lg:col-span-2 space-y-10">
                            ...
                            <section data-reveal>
                                <div class="flex flex-wrap items-center justify-between gap-4">
                                    ...
                                    <button class="rounded-xl bg-secondary px-6 py-2.5 text-sm font-semibold text-secondary-foreground shadow transition-all hover:brightness-110" type="button">Write a Review</button>
                                </div>
                                    ...
                                    @foreach ($reviews as $review)
                                        <article class="rounded-2xl border border-border bg-card p-5 transition-shadow hover:shadow-md">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center gap-3">
                                                    <div class="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 text-sm font-bold text-primary">{{ $review['avatar'] }}</div>
                                                    <div>
                                                ...
                                                @if ($review['verified'])
                                                    <span class="inline-flex items-center gap-1 rounded-full border border-secondary/30 bg-secondary/10 px-2 py-1 text-[10px] font-semibold text-secondary">
                                                        <i data-lucide="shield-check" class="h-3 w-3"></i>Verified
                                                    </span>
                                                @endif
                                            </div>
                                            ...
                                            <p class="mt-3 text-sm leading-relaxed text-muted-foreground">{{ $review['text'] }}</p>
                                        </article>
                                    @endforeach
                                </div>
                            </section>
